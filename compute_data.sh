...
python extract_bb.py --interaction $1 --robot1 $3 --robot2 $3 --green_screen --camera_mode ego1L --bb_mode2
python extract_bb.py --interaction $1 --robot1 $3 --robot2 $3 --green_screen --camera_mode ego2L --bb_mode1
python extract_bb.py --interaction $1 --robot1 $3 --robot2 $3 --green_screen --camera_mode ego1R --bb_mode2
python extract_bb.py --interaction $1 --robot1 $3 --robot2 $3 --green_screen --camera_mode ego2R --bb_mode1
